...
## Features
- Daily wellness check-in (sleep, mood, food, energy)
- Smart to-do list with Eisenhower matrix tagging
- Personal film watchlist with mood-based recommendations
- Personal booklist with mood-based recommendations  
- Productivity Score engine that adapts task suggestions daily
